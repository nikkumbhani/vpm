...
//        assert(NSThread.isMainThread(), "MBProgressHUD needs to be accessed on the main thread.")
    ...
    fileprivate func updateIndicators() {
        ...
        switch self.mode {
        case .indeterminate:
            let activityIndicator = isActivityIndicator ? (self.indicator as! UIActivityIndicatorView) : UIActivityIndicatorView(style: .large)
    ...
    override func draw(_ rect: CGRect) {
        ...
        context.addArc(center: CGPoint(x: CGFloat(boxRect.maxX - CGFloat(radius)), y: CGFloat(boxRect.minY + CGFloat(radius))), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(3 * CGFloat(Double.pi) / 2), endAngle: CGFloat(0), clockwise: false)
        context.addArc(center: CGPoint(x: CGFloat(boxRect.maxX - CGFloat(radius)), y: CGFloat(boxRect.maxY - CGFloat(radius))), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(0), endAngle: CGFloat(CGFloat(Double.pi) / 2), clockwise: false)
        context.addArc(center: CGPoint(x: CGFloat(boxRect.minX + CGFloat(radius)), y: CGFloat(boxRect.maxY - CGFloat(radius))), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(CGFloat(Double.pi) / 2), endAngle: CGFloat(CGFloat(Double.pi)), clockwise: false)
        context.addArc(center: CGPoint(x: CGFloat(boxRect.minX + CGFloat(radius)), y: CGFloat(boxRect.minY + CGFloat(radius))), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(CGFloat(Double.pi)), endAngle: CGFloat(3 * CGFloat(Double.pi) / 2), clockwise: false)
...
extension MBProgressHUD {
    ...
    class func showHUDAddedTo(view: UIView, animated: Bool,message:String = "") -> MBProgressHUD {
        let hud: MBProgressHUD = MBProgressHUD(view: view)
//        hud.mode = .annularIndeterminate
//        hud.color = UIColor.appColor(.BlueColor)
    ...
    class func hideHUDForView(view: UIView, animated: Bool) -> Bool {
        guard let hud = self.HUDForView(view: view) else {
            return false
        }
    ...
    class func hideAllHUDsForView(view: UIView, animated: Bool) -> Int {
        let huds = MBProgressHUD.allHUDsForView(view: view)
        for hud in huds {
            hud.removeFromSuperViewOnHide = true
            hud.hide(animated)
        }
...
class MBBarProgressView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if amount >= radius + 4 && amount <= (rect.size.width - radius - 4) {
            ...
            context.addArc(center: CGPoint(x: CGFloat(rect.size.width - radius - 4), y: CGFloat(rect.size.height / 2)), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(Double.pi), endAngle: CGFloat(angle), clockwise: false)
            ...
            angle = acos(x/radius)
           // if (isnan(angle)) { angle = 0 }
            context.addArc(center: CGPoint(x: CGFloat(rect.size.width - radius - 4), y: CGFloat(rect.size.height / 2)), radius: CGFloat(CGFloat(radius)), startAngle: CGFloat(-Double.pi), endAngle: CGFloat(angle), clockwise: true)
